...
class RockerCoreTest(unittest.TestCase):
    ...
    def test_extension_manager(self):
        ...
        active_extensions = extension_manager.get_active_extensions({'container_name': True, 'home': True, 'extension_blacklist': ['home']})
    ...
    def test_extension_sorting(self):
        class Foo(groot_rocker.core.RockerExtension):
            @classmethod
            def get_name(cls):
                return "foo"

        class Bar(groot_rocker.core.RockerExtension):
            @classmethod
            def get_name(cls):
                return "bar"
